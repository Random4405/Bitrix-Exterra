...
<div class="about-wrapper">
  ...
  <div class="r-wrapper">
    ...
    <h3 class="about-why">Почему мы? Потому что мы заботимся о Вас, своих клиентах.</h3>
    ...
    <h3 class="about-how">Как сделать этот выбор? Ответ на вопрос одновременно и прост, и сложен.</h3>
    ...
    <h3 class="about-because">«Экстерра Групп» дорожит своей репутацией. Поэтому вы не получите от нас предложение купить
    продукцию сомнительного качества от недобросовестных производителей.</h3>

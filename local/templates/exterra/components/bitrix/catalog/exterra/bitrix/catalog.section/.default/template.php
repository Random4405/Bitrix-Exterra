...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	?>
      ...
      <?if ($arItem['DISPLAY_PROPERTIES']['nalichie']['VALUE']):?>
            <p class="product-card--green-badge">В наличии</p>
      <?endif;?>
        <div class="product-card--image"><a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"><img class="img-responsive" src="<?=$file['src']?>" alt=""></a></div>

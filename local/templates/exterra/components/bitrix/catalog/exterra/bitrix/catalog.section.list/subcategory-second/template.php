	...
	switch ($arParams['VIEW_MODE'])
	{
		...
		case 'TILE':
			...
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				if ($num == 0) echo '<div class="flex-row">';
				?>
				      
       
 <div class="img-wrapper" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
	<a href="<? echo $arSection['SECTION_PAGE_URL']; ?>" title="<? echo $arSection['PICTURE']['TITLE']; ?>">
          <div class="texture-name"><? echo $arSection['NAME']; ?></div>
          <img class="img-responsive" src="<? echo $arSection['PICTURE']['SRC']; ?>" alt="">
	</a>
</div>

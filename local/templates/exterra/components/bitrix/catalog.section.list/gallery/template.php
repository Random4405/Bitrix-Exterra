...
$arViewStyles = array(
	...
	'LINE' => array(
		...
		'EMPTY_IMG' => 'http://exterragroup.ru/upload/iblock/9da/9dacec99bb8810f16ffb75ba5e00bae9.jpg'
	),
	'TEXT' => array(
	...
	switch ($arParams['VIEW_MODE'])
	{
			...
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				<div class="subcategory-wrapper">
					  <div class="subcategory-card" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
						...
						<ul>
						<?
						  $arFilter = Array('IBLOCK_ID'=>6, 'GLOBAL_ACTIVE'=>'Y', 'SECTION_ID' => $arSection['ID']);
		...
		case 'TILE':
			...
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				?>
					<div class="category-wrapper mb10" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
						<div class="img-wrapper">
							<a href="<? echo $arSection['SECTION_PAGE_URL']; ?>" title="<? echo $arSection['NAME']; ?>"><span class="texture-name"><? echo $arSection['NAME']; ?></span> <img src="<? echo $arSection['PICTURE']['SRC']; ?>" alt="" title="<? echo $arSection['NAME']; ?>"> </a>
						</div>
					</div>
